...
const Navbar = () => {
    ...
    return (
        <>
            ...
            >
                <nav className="max-w-[1400px] mx-auto bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-white/20 dark:border-gray-800/30 shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] rounded-[24px] overflow-hidden pointer-events-auto transition-all duration-300">
