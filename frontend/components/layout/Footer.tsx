...
const Footer = () => {
    ...
    return (
        <footer
            id="contact"
            className="w-full border-t border-gray-200 bg-[#050505] text-[#f2f2ed] transition-colors dark:border-white/10"
        >
            <m.div
            ...
            >
                <m.div variants={fadeUp} custom={0} className="grid gap-12 lg:grid-cols-[1.2fr_1fr_1fr_1fr] lg:gap-10">
                    ...
                    <m.div variants={fadeUp} custom={1}>
                        <p className="mb-4 text-xs font-semibold uppercase tracking-[0.2em] text-white/40">Product</p>
                    ...
                    <m.div variants={fadeUp} custom={2}>
                        <p className="mb-4 text-xs font-semibold uppercase tracking-[0.2em] text-white/40">Account</p>
                        <ul className="flex flex-col gap-2.5 text-sm font-medium">
                            <li>
                                <Link href="/register" className="text-white/70 transition-colors hover:text-[#d4ff00]">
                                    Create account
                                </Link>
                            </li>
                            <li>
                                <Link href="/login" className="text-white/70 transition-colors hover:text-[#d4ff00]">
                                    Sign in
                                </Link>
                            </li>
                        </ul>
                    ...
                    <m.div variants={fadeUp} custom={3}>
                        <p className="mb-4 text-xs font-semibold uppercase tracking-[0.2em] text-white/40">Contact</p>
                        <a
                            href="mailto:hello@smartsplit.app"
                            className="inline-flex items-center gap-2 text-sm font-medium text-[#d4ff00] transition-colors hover:text-[#e8ff4d]"
                        >
                            <Mail className="h-4 w-4" strokeWidth={1.5} />
                            hello@smartsplit.app
                        </a>
                        <p className="mt-3 text-sm text-white/45">Questions or feedback? We&apos;d love to hear from you.</p>

                        <p className="mb-3 mt-8 text-xs font-semibold uppercase tracking-[0.2em] text-white/40">Legal</p>
                ...
                <m.div
                    variants={fadeUp}
                    custom={4}
                    className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 text-xs text-white/40 sm:flex-row sm:text-sm"
                >
