...
export interface AnimatedThemeTogglerProps {
  sound?: boolean;
  /** Controlled dark state (e.g. from ThemeContext). */
  isDark?: boolean;
  /** Controlled toggle handler (e.g. ThemeContext toggleTheme). */
  onToggle?: () => void;
}
...
export function AnimatedThemeToggler({
  ...
  const isDark = controlled ? (isDarkProp ?? false) : isDarkInternal;

  useEffect(() => {
    setIsDarkInternal(document.documentElement.classList.contains("dark"));
  ...
  useEffect(() => {
    if (controlled && isDarkProp != null) {
      setIsDarkInternal(isDarkProp);
    }
  }, [controlled, isDarkProp]);
