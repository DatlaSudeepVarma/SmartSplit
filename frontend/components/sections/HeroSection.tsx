    ...
    return (
        <section className="pt-32 sm:pt-44 pb-20 sm:pb-32 px-6 relative overflow-visible">
            ...
            <div className="max-w-[1200px] mx-auto text-center relative z-10">
                ...
                >
                    <h1 className="text-4xl sm:text-7xl md:text-8xl lg:text-9xl font-black mb-10 leading-[0.9] text-gray-900 dark:text-white tracking-tighter uppercase italic">
                        SPLIT <br />
                ...
                <motion.p
                    ...
                    className="text-lg sm:text-2xl text-gray-600 dark:text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed font-bold px-4 sm:px-0"
                >
                ...
                >
                    <motion.button
                        ...
                        className="group relative px-8 py-4 sm:px-12 sm:py-6 text-xl sm:text-2xl font-black text-white bg-brand-green rounded-3xl shadow-[0_20px_50px_-10px_rgba(34,197,94,0.5)] transition-all overflow-hidden w-full sm:w-auto"
                    >
                    ...
                    <motion.button
                        ...
                        className="px-8 py-4 sm:px-12 sm:py-6 text-xl sm:text-2xl font-bold text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-900 border-2 border-transparent rounded-3xl shadow-xl transition-all w-full sm:w-auto"
                    >
                        Log In
                    </motion.button>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="mt-20 flex flex-wrap justify-center items-center gap-x-6 sm:gap-x-12 gap-y-6 opacity-60 grayscale hover:grayscale-0 transition-all duration-700"
                >
                    <div className="flex items-center gap-2 font-black text-lg sm:text-2xl"><ShieldCheck size={20} className="sm:w-6 sm:h-6" /> SECURE</div>
                    <div className="flex items-center gap-2 font-black text-lg sm:text-2xl"><Smartphone size={20} className="sm:w-6 sm:h-6" /> MOBILE FIRST</div>
                    <div className="flex items-center gap-2 font-black text-lg sm:text-2xl"><Star size={20} className="sm:w-6 sm:h-6" /> 4.9 RATING</div>
                </motion.div>
            </div>
        </section>
    );
